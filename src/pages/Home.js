        ...
        <div className='container has-text-centered-mobile'>
          <div className='columns'>
            ...
            RWANDA OPEN SOURCE COMMUNITY
              ...
              Grow through what you do with <span role='img' aria-label='heart'> ❤️ </span>, Open Source from Rwanda.
              </div>
              <p className='has-padding-7-mobile'>
              A community driven to make and publish Open Source contents and softwares with
              the power of distributed peer review and transparency of process.
              </p>
              <br />
              <p>
                <a href='/about' className='button custom-button'> Learn more </a>
              </p>
            </div>
            <div className='column is-half'>
              <img src={TeamWork} alt='teamwork' className='image has-padding-7-mobile' />
            </div>
          </div>
        </div>
